...
filename=""
bucket = s3.Bucket('snehachitrebucket1')
#exists = True
...
def upload_file():
    if request.method == 'POST':
        ...
        print folderpath
        s3.Object('snehachitrebucket1',filename).put(Body=contents)
        ...
        #     names=f['Key']
        #     url="https://s3-us-west-2.amazonaws.com/snehachitrebucket1/"+names
        #     urls.append([])
        #     urls[k].append(url)
        #     urls[k].append(names)
        #     k=k+1
...
def files():
    ...
    if request.method == 'POST':
        ...
        if 'list' in request.form:
            ...
            print "2"
            response=client.list_objects(Bucket='snehachitrebucket1')
            print response
            ...
            # print filename
            # response = client.delete_object(Bucket='snehachitrebucket1',Key=filename)
            # print 'file deleted'
